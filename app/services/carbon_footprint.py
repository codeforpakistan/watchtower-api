...
class CarbonFootprintCalculator:
    ...
    def calculate_website_footprint(
        ...
        # Calculate different components of carbon footprint
        ...
        total_energy_kwh = total_co2 / energy_source.value * 1000  # Convert back to kWh
        
        # Generate recommendations
        recommendations = self._generate_carbon_recommendations(
            page_size_mb, total_co2, server_response_time_ms
        )
        
        # Determine confidence level
        confidence = self._determine_confidence_level(
            server_response_time_ms, monthly_visitors
        )
        ...
        return CarbonFootprintResult(
            ...
            methodology="Sustainable Web Design Model + Website Carbon Calculator",
